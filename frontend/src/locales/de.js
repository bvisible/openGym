...
export default {
  ...
  'Finish the payment in the window that just opened.': 'Schließen Sie die Zahlung im gerade geöffneten Fenster ab.',
  'Holding your place…': 'Platz wird reserviert…',
  'How would you like to pay?': 'Wie möchten Sie bezahlen?',
  'No online payment is set up. Ask your club.': 'Keine Online-Zahlung eingerichtet. Wenden Sie sich an Ihren Club.',
  'Open the payment page again': 'Zahlungsseite erneut öffnen',
  'Pay later': 'Später bezahlen',
  'Payment received': 'Zahlung erhalten',
  'Scan this code with {0}': 'Scannen Sie diesen Code mit {0}',
  'See you at the class.': 'Bis zum Kurs.',
  'That did not go through. Try again in a moment.': 'Das hat nicht geklappt. Versuchen Sie es gleich noch einmal.',
  'That slot could not be held. Try another time.': 'Dieser Platz konnte nicht freigehalten werden. Versuchen Sie es zu einem anderen Zeitpunkt.',
  ...
  'Your place is booked': 'Ihr Platz ist gebucht',
  'or enter this code in the app': 'oder geben Sie diesen Code in der App ein',
}
