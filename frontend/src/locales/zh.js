...
export default {
  ...
  'Classes tab': '课程标签',
  'Shows your club’s classes in the bottom bar.': '在底部导航栏显示你的俱乐部课程。',
  'Weight unit': '重量单位',
  ...
  'Offered by your club': '你的俱乐部提供',
  'Load one and it becomes yours — adapt it as you like, the club’s copy does not change.': '加载一个后就是你的了——你可以随意调整，俱乐部的副本不会改变。',
  '“{0}” added to your routines': '“{0}”已加入你的训练日',
  ...
  'Scan this code with {0}': '请使用 {0} 扫描此代码',
  'See you at the class.': '课上见。',
  'That did not go through. Try again in a moment.': '付款未成功，请稍后重试。',
  'That slot could not be held. Try another time.': '该名额无法保留，请选择其他时间。',
  'The code could not be shown.': '无法显示此代码。',
  ...
  'Assessments': '评估',
  'Could not answer — try again when you are online': '无法回复——恢复联网后重试。',
  'Could not open the conversation.': '无法打开对话。',
  'Demo': '演示',
  'Demo data reset': '演示数据已重置',
  'Earlier': '更早',
  'Example data, stored only in this browser — change anything you like.': '示例数据，仅保存在此浏览器中——你可以随意修改。',
  'Exercise': '动作',
  'First assessment — nothing to compare yet.': '首次评估——暂无可比数据。',
  'Follows your training': '关注你的训练',
  'Follows your training — no account for messages': '关注你的训练——没有可用于消息的账号',
  'Last assessment': '最近一次评估',
  'Later': '更晚',
  'No assessment yet. Your coach measures them — ask at your next session.': '还没有评估记录。由教练负责测量——下次训练时问问教练吧。',
  'No change since the previous assessment.': '与上次评估相比没有变化。',
  'No exercises yet.': '还没有动作。',
  'Not now': '暂时不用',
  'Nothing recorded.': '没有记录。',
  'Nothing said yet. Ask what you like — your coach answers here.': '还没有消息。想问什么都可以 — 你的教练在这里回复。',
  'Opens the club’s messaging': '打开俱乐部的消息',
  'Passkey sign-in, sync across your devices, your own data.': '通行密钥登录，跨设备同步，数据完全属于你。',
  'Program declined': '方案已拒绝',
  'Program from your coach': '教练发来的方案',
  'Program updated — {0} routines replaced': '方案已更新——替换了 {0} 个训练日',
  'Puts the example plan, workouts and weigh-ins back the way they started.': '将示例计划、训练记录和称重记录恢复到初始状态。',
  'Reset': '重置',
  'Reset demo data': '重置演示数据',
  'Reset demo data?': '要重置演示数据吗？',
  'See the schedule': '查看日程',
  'Self-host openGym': '自行托管 openGym',
  'Sent by your coach': '由你的教练发送',
  'Sent by {0}': '由 {0} 发送',
  'Signed in with your Neoffice account.': '已用你的 Neoffice 账号登录。',
  'Signing in…': '正在登录…',
  'This could not be read.': '无法读取此内容。',
  'This program could not be read: {0}': '无法读取此方案：{0}',
  'Week {0} of {1} of your program': '你的方案第 {0} 周，共 {1} 周',
  'What your coach measured, and what changed': '教练测量了什么，又有什么变化',
  'Write to your coach': '给教练发消息',
  'Yesterday': '昨天',
  'Your Mon–Sun schedule will follow this program. Days it leaves empty become rest days.': '你周一至周日的日程会按这个方案安排，留空的日子会变成休息日。',
  'Your assessments could not be loaded.': '无法加载你的评估记录。',
  'Your club': '你的俱乐部',
  'Add a photo': '添加照片',
  'Remove the photo': '移除照片',
  'Only a photo can be sent here.': '这里只能发送照片。',
  'That photo is too large. Take it again or send a smaller one.': '这张照片太大了。请重拍或发送更小的照片。',
  'Your club answers here': '你的俱乐部在这里回复',
  'Your coach': '你的教练',
  'Your coach sent you a program': '你的教练给你发来了一个方案',
  'Your coach writes your plan. You can train it and log your sets — the routines themselves are theirs to change.': '你的计划由教练制定。你可以照着训练并记录组数——但只有教练能修改训练日本身。',
  'Your goals': '你的目标',
  'Your journal is saved first, then this device is signed out.': '会先保存你的记录，然后此设备才会退出登录。',
  'Your next classes': '你接下来的课程',
  'You’re in the demo': '你正在体验演示模式',
  'by {0}': '截至 {0}',
  'reached': '已达成',
  'valid until {0}': '有效期至 {0}',
  'version {0}': '版本 {0}',
  '{0} improved': '{0} 项有所改善',
  '{0} sent you a program': '{0} 给你发来了一个方案',
  //// Neoffice — physical assessment glossary, translated at runtime via t(server value).
  'Abdominal skinfold': '腹部皮褶',
  'Arm circumference': '臂围',
  'BMI': 'BMI',
  'Bench press 1RM': '卧推 1RM',
  'Biceps skinfold': '肱二头肌皮褶',
  'Blood pressure diastolic': '舒张压',
  'Blood pressure systolic': '收缩压',
  'Body fat 3 folds': '体脂率（3处皮褶）',
  'Body fat': '体脂率',
  'Burpees in 1 minute': '1分钟波比跳',
  'Chest circumference': '胸围',
  'Chest skinfold': '胸部皮褶',
  'Cooper 12-minute distance': 'Cooper 12分钟距离',
  'Fat mass': '脂肪量',
  ...
  'Ruffier index': 'Ruffier 指数',
  'Shoulder mobility': '肩部灵活性',
  'Single leg stance eyes closed': '单腿站立（闭眼）',
  'Single leg stance': '单腿站立',
  'Sit and reach': '坐位体前屈',
  'Squat 1RM': '深蹲 1RM',
  'Subscapular skinfold': '肩胛下皮褶',
  'Superset · do these back-to-back, rest after both': '超级组 · 连续完成，两个都做完再休息',
  'Suprailiac skinfold': '髂上皮褶',
  'Thigh circumference': '大腿围',
  'Thigh skinfold': '大腿皮褶',
  'This replaces the routine you got from an earlier version of this program.': '这将替换你从此方案早期版本中获得的训练日。',
  'This replaces the {0} routines you got from an earlier version of this program.': '这将替换你从此方案早期版本中获得的 {0} 个训练日。',
  'Triceps skinfold': '肱三头肌皮褶',
  ...
  'Share this session': '分享这次训练',
  'You choose what appears. The club’s name and logo are always on it.': '由您决定显示什么。俱乐部名称和标志始终显示。',
  'Session done': '训练完成',
  'Weight moved': '举起重量',
  ...
  'Show every exercise': '显示所有动作',
  'Show what suits me': '显示适合我的',
  'Showing every exercise': '正在显示所有动作',
  ...
  'Get ready': '准备好',
  'Tap to start now': '点按立即开始',
  //// Neoffice — the membership gate and the renewal signed on the phone (views/MembershipGate.jsx).
  'Ended on {0}': '于 {0} 结束',
  'I have read and I accept the terms of the membership.': '我已阅读并接受会籍条款。',
  'Open my journal': '打开我的日记',
  'Read the terms, accept them and sign: your membership restarts today.': '阅读条款，接受条款并签字：您的会籍将于今天重新开始。',
  'Renew my membership': '续订我的会籍',
  'Renew': '续订',
  'Renewing…': '续订中…',
  'Sign and renew': '签字并续订',
  'Sign here with your finger': '用手指在此签字',
  'Signature': '签名',
  'To use the app, you need a valid membership.': '要使用本应用，您需要有效的会籍。',
  'Valid until {0}.': '有效期至 {0}。',
  'Your club has not written any terms for this membership.': '您的俱乐部尚未为此会籍编写任何条款。',
  'Your club will get in touch about the invoice.': '您的俱乐部将就发票与您联系。',
  'Your club will hand you the invoice.': '您的俱乐部会将发票交给您。',
  'Your membership is renewed.': '您的会籍已续订。',
  'Your {0} membership ended on {1}.': '您的 {0} 会籍已于 {1} 结束。',
  //// Neoffice — rename an exercise, rest per exercise, the floor plan on its own (2026-09-09).
  'Back to the catalogue name': '恢复为目录名称',
  'Catalogue name: {0}': '目录名称：{0}',
  'Each exercise sheet also shows where it is done.': '每张动作卡片也会显示它在哪里完成。',
  'Floor plan': '健身房平面图',
  'For this exercise only. 0 uses your default rest timer ({0} s).': '仅适用于此动作。0 表示使用默认的休息计时（{0} 秒）。',
  'Give it my own name': '自定义名称',
  'Rename this exercise': '重命名这个动作',
  'Rename': '重命名',
  'Rest after each set': '组间休息',
  'Rest {0} s after each set': '组间休息 {0} 秒',
  'Rest: your usual timer, {0} s': '休息：平时的计时，{0} 秒',
  'Tap a machine to find it in the list, or a name to see where it is.': '点击器械可在列表中找到它，或点击名称查看它的位置。',
  'Use my default': '使用我的默认值',
  'Your club has not drawn its floor plan yet.': '您的俱乐部还没有绘制健身房平面图。',
  'Your own name for it, on every screen of your journal. The club and the catalogue keep theirs.': '您为它起的名字，会出现在日记的每个屏幕上。俱乐部和目录会保留它们自己的名字。',
  '{0} zones · find every machine': '{0} 个区域 · 查找每台器械',
  ...
  "Add routine": "添加训练日",
  "Bring another routine into this session": "添加另一个训练日到本次训练",
  "Deload 1RM (%)": "减载 1RM（%）",
  "Finish workout": "结束训练",
  "Layout": "布局",
  "Save": "保存",
  ...
  "no exercises": "没有动作",
  "{0} added — {1}": "{0} 已加入——{1}",
  "Heavier lifts, lower reps.": "更大重量，更少次数。",
  "Volume and progression.": "训练量与进阶。",
  "Balanced, sustainable training.": "均衡且可持续的训练。",
  "Keep strength while leaning out.": "减脂的同时保持力量。",
  "Higher reps, less rest, cardio.": "更多次数，更少休息，有氧。",
  "First months in the gym.": "刚接触力量训练的头几个月。",
  "You know the movements; the numbers need rebuilding.": "你了解动作，只是数据需要重新积累。",
  "Consistent for a while now.": "已经稳定坚持一段时间了。",
  "Routines, exercises, sets and reps, your weekly schedule and progression settings.": "训练计划、动作、组数和次数、你的每周日程和进阶设置。",
  "Your logged training": "你记录的训练",
  "Sets you logged in the review window — weights, reps, times, effort ratings and how long sessions took.": "你在审查期间记录的训练组——重量、次数、时长、强度评分，以及每次训练花费的时间。",
  "Weigh-ins from the same window, and your goal weight if you set one.": "同一时间段内的称重记录，以及你设置过的目标体重（如果有）。",
  "What you tell the Coach": "你告诉教练的信息",
  "Your intake answers, including any limitations or injuries you describe.": "你在问卷中的回答，包括你描述的任何限制或伤病。",
  "Your unit, your language and which effort scale you log.": "你的单位、你的语言，以及你使用的强度量表。",
  ...
  'Ask at the desk for your invoices.': '请到前台查询你的账单。',
  'Current period until {0}': '当前周期至{0}',
  'It ended on {0}.': '已于{0}结束。',
  'My membership': '我的会籍',
  'No invoice yet.': '暂无账单。',
  'No membership on your account': '你的账户没有会籍',
  'Overdue': '逾期',
  'Paid': '已付款',
  'Settle it at the desk or by bank transfer.': '请到前台或通过银行转账结清。',
  'Tap an invoice to open its PDF.': '点按账单可打开其PDF。',
  'The club sets this up at the desk.': '俱乐部会在前台为你设置。',
  'Unpaid': '未付款',
  'You can settle it from here.': '你可以在这里结清。',
  'Your club handles the membership outside the app.': '你的俱乐部在应用外管理会籍。',
  'Your invoices': '你的账单',
  'Your membership could not be loaded.': '无法加载你的会籍。',
  'Your membership has ended': '你的会籍已结束',
  'Your membership': '你的会籍',
  'Your plan, your invoices and what is owed': '你的会籍、你的账单和欠款',
  'due {0}': '到期日{0}',
  'every {0} days': '每{0}天',
  'every {0} months': '每{0}个月',
  'every {0} weeks': '每{0}周',
  'every {0} years': '每{0}年',
  'per day': '每天',
  'per month': '每月',
  ...
  'The Coach is restarting. Try again in a few minutes.': '教练正在重启，请几分钟后再试。',
  'The Coach is busy. Try again in {0} seconds.': '教练很忙，请 {0} 秒后再试。',
