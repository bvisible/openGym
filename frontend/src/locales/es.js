...
export default {
  ...
  'Finish the payment in the window that just opened.': 'Complete el pago en la ventana que se acaba de abrir.',
  'Holding your place…': 'Reservando su plaza…',
  'How would you like to pay?': '¿Cómo desea pagar?',
  'No online payment is set up. Ask your club.': 'No hay ningún pago en línea configurado. Consulte a su club.',
  'Open the payment page again': 'Volver a abrir la página de pago',
  'Pay later': 'Pagar más tarde',
  'Payment received': 'Pago recibido',
  'Scan this code with {0}': 'Escanee este código con {0}',
  'See you at the class.': 'Nos vemos en la clase.',
  'That did not go through. Try again in a moment.': 'El pago no se ha procesado. Inténtelo de nuevo en un momento.',
  'That slot could not be held. Try another time.': 'No se ha podido reservar esa plaza. Pruebe otro horario.',
  ...
  'To pay': 'A pagar',
  'Waiting for your payment…': 'Esperando su pago…',
  'Your place is booked': 'Su plaza está reservada',
  'or enter this code in the app': 'o introduzca este código en la app',
}
