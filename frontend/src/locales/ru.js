...
export default {
  ...
  'Finish the payment in the window that just opened.': 'Завершите оплату в только что открывшемся окне.',
  'Holding your place…': 'Резервируем ваше место…',
  'How would you like to pay?': 'Как вы хотите оплатить?',
  'No online payment is set up. Ask your club.': 'Онлайн-оплата не настроена. Обратитесь в ваш клуб.',
  'Open the payment page again': 'Открыть страницу оплаты ещё раз',
  'Pay later': 'Оплатить позже',
  'Payment received': 'Оплата получена',
  'Scan this code with {0}': 'Отсканируйте этот код с помощью {0}',
  'See you at the class.': 'До встречи на занятии.',
  'That did not go through. Try again in a moment.': 'Оплата не прошла. Попробуйте ещё раз через мгновение.',
  'That slot could not be held. Try another time.': 'Не удалось забронировать это место. Выберите другое время.',
  ...
  'Your place is booked': 'Ваше место забронировано',
  'or enter this code in the app': 'или введите этот код в приложении',
}
