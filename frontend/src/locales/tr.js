...
export default {
  ...
  'Offered by your club': 'Kulübünden sunulanlar',
  'Load one and it becomes yours — adapt it as you like, the club’s copy does not change.': 'Birini yükle, senin olur — istediğin gibi değiştir, kulübün kopyası değişmez.',
  '“{0}” added to your routines': '“{0}”, rutinlerine eklendi',
  ...
  'Book now, pay on the invoice': 'Şimdi rezerve et, faturayla öde',
  'Finish the payment in the window that just opened.': 'Az önce açılan pencerede ödemeyi tamamla.',
  'Holding your place…': 'Yerin ayrılıyor…',
  'How would you like to pay?': 'Nasıl ödemek istersin?',
  'No online payment is set up. Ask your club.': 'Çevrimiçi ödeme ayarlanmamış. Kulübüne danış.',
  'Open the payment page again': 'Ödeme sayfasını tekrar aç',
  'Pay later': 'Daha sonra öde',
  'Payment received': 'Ödeme alındı',
  'Scan this code with {0}': 'Bu kodu {0} ile tara',
  'See you at the class.': 'Derste görüşürüz.',
  'That did not go through. Try again in a moment.': 'Ödeme gerçekleşmedi. Birazdan tekrar dene.',
  'That slot could not be held. Try another time.': 'Bu yer ayrılamadı. Başka bir saat dene.',
  'The code could not be shown.': 'Kod gösterilemedi.',
  'The invoice will follow — nothing to pay right now.': 'Fatura daha sonra gelecek — şu an ödemen gereken bir şey yok.',
  'This screen updates on its own once it goes through.': 'Ödeme gerçekleştiğinde bu ekran kendiliğinden güncellenir.',
  'To pay': 'Ödenecek',
  'Waiting for your payment…': 'Ödemen bekleniyor…',
  'Your place is booked': 'Yerin ayrıldı',
  'or enter this code in the app': 'veya bu kodu uygulamaya gir',
  //// Neoffice — strings that were falling back to raw English (audit 2026-08-25).
  'Assessments': 'Testler',
  'Could not answer — try again when you are online': 'Yanıtlanamadı — çevrimiçi olduğunda tekrar dene.',
  'Could not open the conversation.': 'Sohbet açılamadı.',
  'Demo': 'Demo',
  ...
  'Exercise': 'Egzersiz',
  'First assessment — nothing to compare yet.': 'İlk test — henüz karşılaştıracak bir şey yok.',
  'Follows your training': 'Antrenmanını takip ediyor',
  'Follows your training — no account for messages': 'Antrenmanını takip ediyor — mesajlar için hesabı yok',
  'Last assessment': 'Son test',
  'Later': 'Sonra',
  'No assessment yet. Your coach measures them — ask at your next session.': 'Henüz test yok. Bunları koçun yapar — bir sonraki seansında sor.',
  'No change since the previous assessment.': 'Önceki testten bu yana değişiklik yok.',
  'No exercises yet.': 'Henüz egzersiz yok.',
  'Nothing recorded.': 'Hiçbir şey kaydedilmedi.',
  'Nothing said yet. Ask what you like — your coach answers here.': 'Henüz mesaj yok. Ne istersen sor — koçun burada cevap veriyor.',
  'Opens the club’s messaging': 'Kulübün mesajlaşmasını açar',
  'Passkey sign-in, sync across your devices, your own data.': 'Geçiş anahtarıyla giriş, cihazların arasında eşitleme, kendi verilerin.',
  'Program declined': 'Program reddedildi',
  'Program from your coach': 'Koçundan program',
  'Program updated — {0} routines replaced': 'Program güncellendi — {0} rutin değiştirildi',
  'Puts the example plan, workouts and weigh-ins back the way they started.': 'Örnek planı, antrenmanları ve tartımları başladıkları haline döndürür.',
  'Reset': 'Sıfırla',
  'Reset demo data': 'Demo verilerini sıfırla',
  'Reset demo data?': 'Demo verileri sıfırlansın mı?',
  'See the schedule': 'Programı gör',
  'Self-host openGym': 'openGym’i kendin barındır',
  'Sent by your coach': 'Koçun tarafından gönderildi',
  'Sent by {0}': '{0} tarafından gönderildi',
  'Signed in with your Neoffice account.': 'Neoffice hesabınla giriş yapıldı.',
  'Signing in…': 'Giriş yapılıyor…',
  'This could not be read.': 'Bu okunamadı.',
  'This program could not be read: {0}': 'Bu program okunamadı: {0}',
  'Week {0} of {1} of your program': 'Programında {1} haftadan {0}. hafta',
  'What your coach measured, and what changed': 'Koçunun ölçtükleri ve neyin değiştiği',
  'Write to your coach': 'Koçuna yaz',
  'Yesterday': 'Dün',
  'Your Mon–Sun schedule will follow this program. Days it leaves empty become rest days.': 'Pzt–Paz programın bu programa göre ayarlanacak. Boş bıraktığı günler dinlenme günü olur.',
  'Your assessments could not be loaded.': 'Testlerin yüklenemedi.',
  'Your club': 'Kulübün',
  'Add a photo': 'Fotoğraf ekle',
  'Remove the photo': 'Fotoğrafı kaldır',
  'Only a photo can be sent here.': 'Buraya yalnızca fotoğraf gönderilebilir.',
  'That photo is too large. Take it again or send a smaller one.': 'Bu fotoğraf çok büyük. Yeniden çekin veya daha küçüğünü gönderin.',
  'Your club answers here': 'Kulübün burada cevap veriyor',
  'Your coach': 'Koçun',
  'Your coach sent you a program': 'Koçun sana bir program gönderdi',
  'Your coach writes your plan. You can train it and log your sets — the routines themselves are theirs to change.': 'Planını koçun yazar. Onu uygulayıp setlerini kaydedebilirsin — rutinleri yalnızca koçun değiştirebilir.',
  'Your goals': 'Hedeflerin',
  'Your journal is saved first, then this device is signed out.': 'Önce günlüğün kaydedilir, sonra bu cihazda oturum kapatılır.',
  'Your next classes': 'Sıradaki derslerin',
  'You’re in the demo': 'Demodasın',
  'by {0}': '{0} tarihine kadar',
  'reached': 'Ulaşıldı',
  'valid until {0}': '{0} tarihine kadar geçerli',
  'version {0}': 'sürüm {0}',
  '{0} improved': '{0} gelişti',
  '{0} sent you a program': '{0} sana bir program gönderdi',
  //// Neoffice — physical assessment glossary, translated at runtime via t(server value).
  'Abdominal skinfold': 'Abdominal kıvrım',
  'Arm circumference': 'Kol çevresi',
  'BMI': 'VKİ',
  'Bench press 1RM': 'Bench press 1RM',
  'Biceps skinfold': 'Biceps kıvrımı',
  'Blood pressure diastolic': 'Diyastolik kan basıncı',
  'Blood pressure systolic': 'Sistolik kan basıncı',
  'Body fat 3 folds': 'Vücut yağ oranı (3 kıvrım)',
  'Body fat': 'Vücut yağ oranı',
  'Burpees in 1 minute': '1 dakikada burpee',
  'Chest circumference': 'Göğüs çevresi',
  'Chest skinfold': 'Göğüs kıvrımı',
  'Cooper 12-minute distance': 'Cooper 12 dakika mesafesi',
  'Fat mass': 'Yağ kütlesi',
  'Handgrip strength': 'Kavrama kuvveti',
  'Height': 'Boy',
  'Hip circumference': 'Kalça çevresi',
  'Hip flexion': 'Kalça fleksiyonu',
  'Lean mass': 'Yağsız kütle',
  'Load lifted': 'Kaldırılan ağırlık',
  'Plank endurance': 'Plank (dayanıklılık)',
  'Plank hold': 'Plank (tutma)',
  'Push-ups max': 'Şınav (maksimum)',
  'Repetitions': 'Tekrarlar',
  'Resting heart rate': 'Dinlenik nabız',
  'Ruffier P1': 'Ruffier P1',
  'Ruffier P2': 'Ruffier P2',
  'Ruffier P3': 'Ruffier P3',
  'Ruffier index': 'Ruffier indeksi',
  'Shoulder mobility': 'Omuz hareketliliği',
  'Single leg stance eyes closed': 'Tek ayak üzerinde denge (gözler kapalı)',
  'Single leg stance': 'Tek ayak üzerinde denge',
  'Sit and reach': 'Otur-eriş testi',
  'Squat 1RM': 'Squat 1RM',
  'Subscapular skinfold': 'Subskapular kıvrım',
  'Superset · do these back-to-back, rest after both': 'Süperset · art arda yap, ikisinden sonra dinlen',
  'Suprailiac skinfold': 'Suprailiak kıvrım',
  'Thigh circumference': 'Uyluk çevresi',
  'Thigh skinfold': 'Uyluk kıvrımı',
  'This replaces the routine you got from an earlier version of this program.': 'Bu, bu programın önceki bir sürümünden aldığın rutini değiştirir.',
  'This replaces the {0} routines you got from an earlier version of this program.': 'Bu, bu programın önceki bir sürümünden aldığın {0} rutini değiştirir.',
  'Triceps skinfold': 'Triceps kıvrımı',
  'VO2max Cooper': 'VO2max Cooper',
  'Waist circumference': 'Bel çevresi',
  'Waist hip ratio': 'Bel-kalça oranı',
  'Wall sit': 'Duvar oturuşu',
  'Weight': 'Kilo',
  'animations': 'Animasyonlar',
  'exercise data': 'Egzersiz verileri',
  ...
  'Share this session': 'Bu antrenmanı paylaş',
  'You choose what appears. The club’s name and logo are always on it.': 'Ne görüneceğini siz seçersiniz. Kulübün adı ve logosu her zaman yer alır.',
  'Session done': 'Antrenman tamam',
  'Weight moved': 'Kaldırılan ağırlık',
  ...
  'Ended on {0}': '{0} tarihinde sona erdi',
  'I have read and I accept the terms of the membership.': 'Üyelik koşullarını okudum ve kabul ediyorum.',
  'Open my journal': 'Günlüğümü aç',
  'Read the terms, accept them and sign: your membership restarts today.': 'Koşulları okuyun, kabul edin ve imzalayın: üyeliğiniz bugün yeniden başlıyor.',
  'Renew my membership': 'Üyeliğimi yenile',
  'Renew': 'Yenile',
  'Renewing…': 'Yenileniyor…',
  'Sign and renew': 'İmzala ve yenile',
  'Sign here with your finger': 'Buraya parmağınızla imzalayın',
  'Signature': 'İmza',
  'To use the app, you need a valid membership.': 'Uygulamayı kullanmak için geçerli bir üyeliğe sahip olmanız gerekir.',
  'Valid until {0}.': '{0} tarihine kadar geçerli.',
  'Your club has not written any terms for this membership.': 'Kulübünüz bu üyelik için herhangi bir koşul yazmadı.',
  'Your club will get in touch about the invoice.': 'Kulübünüz fatura hakkında sizinle iletişime geçecek.',
  'Your club will hand you the invoice.': 'Kulübünüz faturayı size teslim edecek.',
  'Your membership is renewed.': 'Üyeliğiniz yenilendi.',
  'Your {0} membership ended on {1}.': '{0} üyeliğiniz {1} tarihinde sona erdi.',
  //// Neoffice — rename an exercise, rest per exercise, the floor plan on its own (2026-09-09).
  'Back to the catalogue name': 'Katalog adına dön',
  'Catalogue name: {0}': 'Katalog adı: {0}',
  'Each exercise sheet also shows where it is done.': 'Her egzersiz kartı, nerede yapıldığını da gösterir.',
  'Floor plan': 'Salon planı',
  'For this exercise only. 0 uses your default rest timer ({0} s).': 'Yalnızca bu egzersiz için. 0, varsayılan dinlenme sayacınızı kullanır ({0} sn).',
  'Give it my own name': 'Kendi adımı ver',
  'Rename this exercise': 'Bu egzersizi yeniden adlandır',
  'Rename': 'Yeniden adlandır',
  'Rest after each set': 'Her setten sonra dinlenme',
  'Rest {0} s after each set': 'Her setten sonra {0} sn dinlenme',
  'Rest: your usual timer, {0} s': 'Dinlenme: her zamanki sayacınız, {0} sn',
  'Tap a machine to find it in the list, or a name to see where it is.': 'Listede bulmak için bir makineye, nerede olduğunu görmek için bir isme dokunun.',
  'Use my default': 'Varsayılanımı kullan',
  'Your club has not drawn its floor plan yet.': 'Kulübünüz henüz salon planını çizmedi.',
  'Your own name for it, on every screen of your journal. The club and the catalogue keep theirs.': 'Bunun için kendi adınız, günlüğünüzün her ekranında. Kulüp ve katalog kendi adlarını korur.',
  '{0} zones · find every machine': '{0} bölge · her makineyi bul',
  ...
  "Bring another routine into this session": "Bu antrenmana başka bir rutin ekle",
  ...
  "Heavier lifts, lower reps.": "Daha ağır kaldırışlar, daha az tekrar.",
  "Volume and progression.": "Hacim ve ilerleme.",
  "Balanced, sustainable training.": "Dengeli, sürdürülebilir antrenman.",
  "Keep strength while leaning out.": "Yağ kaybederken gücü korumak.",
  "Higher reps, less rest, cardio.": "Daha çok tekrar, daha az dinlenme, kardiyo.",
  "First months in the gym.": "Spor salonunda ilk aylar.",
  "You know the movements; the numbers need rebuilding.": "Hareketleri biliyorsun, sadece rakamları yeniden inşa etmen gerekiyor.",
  "Consistent for a while now.": "Bir süredir düzenli.",
  "Routines, exercises, sets and reps, your weekly schedule and progression settings.": "Rutinler, egzersizler, set ve tekrarlar, haftalık programın ve ilerleme ayarların.",
  "Your logged training": "Kaydettiğin antrenman",
  "Sets you logged in the review window — weights, reps, times, effort ratings and how long sessions took.": "İnceleme döneminde kaydettiğin setler — ağırlıklar, tekrarlar, süreler, efor puanları ve seansların ne kadar sürdüğü.",
  "Weigh-ins from the same window, and your goal weight if you set one.": "Aynı dönemdeki tartımların ve varsa hedef kilon.",
  "What you tell the Coach": "Koça anlattıkların",
  "Your intake answers, including any limitations or injuries you describe.": "Anket cevapların, belirttiğin kısıtlamalar veya sakatlıklar da dahil olmak üzere.",
  "Your unit, your language and which effort scale you log.": "Birimin, dilin ve kullandığın efor ölçeği.",
  ...
  'Ask at the desk for your invoices.': 'Faturalarını resepsiyonda sor.',
  'Current period until {0}': '{0} tarihine kadar geçerli dönem',
  'It ended on {0}.': '{0} tarihinde sona erdi.',
  'My membership': 'Üyeliğim',
  'No invoice yet.': 'Henüz fatura yok.',
  'No membership on your account': 'Hesabında üyelik yok',
  'Overdue': 'Gecikmiş',
  'Paid': 'Ödendi',
  'Settle it at the desk or by bank transfer.': 'Resepsiyonda ya da banka havalesiyle öde.',
  'Tap an invoice to open its PDF.': 'PDF’ini açmak için bir faturaya dokun.',
  'The club sets this up at the desk.': 'Kulüp bunu resepsiyonda ayarlar.',
  'Unpaid': 'Ödenmedi',
  'You can settle it from here.': 'Buradan ödeyebilirsin.',
  'Your club handles the membership outside the app.': 'Kulübün üyeliği uygulama dışında yönetiyor.',
  'Your invoices': 'Faturaların',
  'Your membership could not be loaded.': 'Üyeliğin yüklenemedi.',
  'Your membership has ended': 'Üyeliğin sona erdi',
  'Your membership': 'Üyeliğin',
  'Your plan, your invoices and what is owed': 'Üyeliğin, faturaların ve ödenmesi gereken tutar',
  'due {0}': 'vade: {0}',
  'every {0} days': '{0} günde bir',
  'every {0} months': '{0} ayda bir',
  'every {0} weeks': '{0} haftada bir',
  'every {0} years': '{0} yılda bir',
  'per day': 'günlük',
  'per month': 'aylık',
  'per week': 'haftalık',
  'per year': 'yıllık',
