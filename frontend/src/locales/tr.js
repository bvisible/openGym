...
export default {
  ...
  'Book now, pay on the invoice': 'Şimdi rezerve edin, faturayla ödeyin',
  'Finish the payment in the window that just opened.': 'Az önce açılan pencerede ödemeyi tamamlayın.',
  'Holding your place…': 'Yeriniz ayrılıyor…',
  'How would you like to pay?': 'Nasıl ödemek istersiniz?',
  'No online payment is set up. Ask your club.': 'Çevrimiçi ödeme ayarlanmamış. Kulübünüze danışın.',
  'Open the payment page again': 'Ödeme sayfasını tekrar açın',
  'Pay later': 'Daha sonra ödeyin',
  'Payment received': 'Ödeme alındı',
  'Scan this code with {0}': 'Bu kodu {0} ile tarayın',
  'See you at the class.': 'Derste görüşürüz.',
  'That did not go through. Try again in a moment.': 'Ödeme gerçekleşmedi. Birazdan tekrar deneyin.',
  'That slot could not be held. Try another time.': 'Bu yer ayrılamadı. Başka bir saat deneyin.',
  'The code could not be shown.': 'Kod gösterilemedi.',
  'The invoice will follow — nothing to pay right now.': 'Fatura daha sonra gelecek — şu an ödemeniz gereken bir şey yok.',
  ...
  'Your place is booked': 'Yeriniz ayrıldı',
  'or enter this code in the app': 'veya bu kodu uygulamaya girin',
}
