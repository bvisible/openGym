...
export default {
  ...
  'Finish the payment in the window that just opened.': 'Conclua o pagamento na janela que acabou de abrir.',
  'Holding your place…': 'A reservar a sua vaga…',
  'How would you like to pay?': 'Como prefere pagar?',
  'No online payment is set up. Ask your club.': 'Não há nenhum pagamento online configurado. Contacte o seu clube.',
  'Open the payment page again': 'Abrir novamente a página de pagamento',
  'Pay later': 'Pagar mais tarde',
  'Payment received': 'Pagamento recebido',
  'Scan this code with {0}': 'Digitalize este código com {0}',
  'See you at the class.': 'Vemo-nos na aula.',
  'That did not go through. Try again in a moment.': 'O pagamento não foi concluído. Tente novamente dentro de instantes.',
  'That slot could not be held. Try another time.': 'Não foi possível reservar essa vaga. Tente outro horário.',
  ...
  'To pay': 'A pagar',
  'Waiting for your payment…': 'A aguardar o seu pagamento…',
  'Your place is booked': 'A sua vaga está reservada',
  'or enter this code in the app': 'ou introduza este código na app',
}
