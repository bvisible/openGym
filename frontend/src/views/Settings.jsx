...
export default function Settings() {
  ...
  //// it here would mean a second session store next to Frappe's, which is
    ...
    <Section title={MOBILE ? t('Your data') : DEMO ? t('Demo') : t('Account')}>
      {MOBILE ? <>
        ...
        {/* //// Neoffice — the member is signed in with their Neoffice account:
            no passkey to create, no profile to pick. Signing out ends the Frappe
            session and leaves for /login, which is why there is nothing here
            about "clearing this device". */}
...
//// for an invite code when the instance was invite-only. Accounts are Frappe
//// accounts now: a member exists because the club created them, and there is
//// nothing to register from inside the journal.
