...
import {
  ...
  getLang, dateLocale, t, instrFor, exerciseNameFor, exerciseNameSearchText, catalogueNameFor, setExerciseAliases, exerciseAliasOf, getVersion, _setLangState
} from './i18n-core.js'

export {
  LANGS, INSTR_LANGS, EXERCISE_NAME_LANGS, DATE_LOCALES,
  getLang, dateLocale, t, instrFor, exerciseNameFor, exerciseNameSearchText, catalogueNameFor, setExerciseAliases, exerciseAliasOf
}
