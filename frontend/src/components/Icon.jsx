...
const P = {
  ...
  //// Neoffice — the password eye on the sign-in screen (views/SignIn.jsx).
  eye: <><path d="M2.3 12s3.5-6.5 9.7-6.5 9.7 6.5 9.7 6.5-3.5 6.5-9.7 6.5S2.3 12 2.3 12Z" /><circle cx="12" cy="12" r="3" /></>,
  eyeOff: <><path d="M10.6 5.9A10 10 0 0 1 12 5.5c6.2 0 9.7 6.5 9.7 6.5a16 16 0 0 1-2.2 3.1" /><path d="M14.1 14.1a3 3 0 0 1-4.2-4.2" /><path d="M6.7 6.7C4 8.6 2.3 12 2.3 12s3.5 6.5 9.7 6.5c1.6 0 3-.4 4.3-1" /><path d="M3 3l18 18" /></>,
  ...
  //// Neoffice — added: the universal "more actions" affordance. The
  //// workout screen had five editing buttons stacked under the sets;
  //// they live behind this now.
  ellipsis: <path d="M5.5 12h.01M12 12h.01M18.5 12h.01" />,
