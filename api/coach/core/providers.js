...
export const HTTP_PROVIDERS = Object.freeze({
  ...
  //// Neoffice — the club's own assistant, behind the Frappe instance. The journal
  //// posts the same Chat Completions request to a whitelisted endpoint
  ...
  nora: Object.freeze({
    ...
    defaultBase: null, baseUrl: true, keyOptional: true,
    defaultModel: 'nora',
    keyPlaceholder: '(none — the club pays)'
  })
});
